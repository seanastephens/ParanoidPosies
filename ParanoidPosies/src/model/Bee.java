...
public class Bee extends Bug {
	...
	public Bee(Point location, GameBoard board) {
		...
		/*
		 * ImageReg i = ImageReg.getInstance(); images[0][0][0] =
		 * i.getImageFromStr("Bee00"); images[0][0][1] =
		 * i.getImageFromStr("Bee01"); images[0][0][2] =
		 * i.getImageFromStr("Bee02"); images[0][1][0] =
		 * i.getImageFromStr("Bee10"); images[0][1][1] =
		 * i.getImageFromStr("Bee11"); images[0][1][2] =
		 * i.getImageFromStr("Bee12"); images[0][2][0] =
		 * i.getImageFromStr("Bee20"); images[0][2][1] =
		 * i.getImageFromStr("Bee21"); images[0][2][2] =
		 * i.getImageFromStr("Bee22"); images[0][3][0] =
		 * i.getImageFromStr("Bee30"); images[0][3][1] =
		 * i.getImageFromStr("Bee31"); images[0][3][2] =
		 * i.getImageFromStr("Bee32"); images[0][4][0] =
		 * i.getImageFromStr("Bee40"); images[0][4][1] =
		 * i.getImageFromStr("Bee41"); images[0][4][2] =
		 * i.getImageFromStr("Bee42"); images[0][5][0] =
		 * i.getImageFromStr("Bee50"); images[0][5][1] =
		 * i.getImageFromStr("Bee51"); images[0][5][2] =
		 * i.getImageFromStr("Bee52"); images[0][6][0] =
		 * i.getImageFromStr("Bee60"); images[0][6][1] =
		 * i.getImageFromStr("Bee61"); images[0][6][2] =
		 * i.getImageFromStr("Bee62"); images[0][7][0] =
		 * i.getImageFromStr("Bee70"); images[0][7][1] =
		 * i.getImageFromStr("Bee71"); images[0][7][2] =
		 * i.getImageFromStr("Bee72");
		 * 
		 * images[1][0][0] = i.getImageFromStr("BeeS00"); images[1][0][1] =
		 * i.getImageFromStr("BeeS01"); images[1][0][2] =
		 * i.getImageFromStr("BeeS02"); images[1][1][0] =
		 * i.getImageFromStr("BeeS10"); images[1][1][1] =
		 * i.getImageFromStr("BeeS11"); images[1][1][2] =
		 * i.getImageFromStr("BeeS12"); images[1][2][0] =
		 * i.getImageFromStr("BeeS20"); images[1][2][1] =
		 * i.getImageFromStr("BeeS21"); images[1][2][2] =
		 * i.getImageFromStr("BeeS22"); images[1][3][0] =
		 * i.getImageFromStr("BeeS30"); images[1][3][1] =
		 * i.getImageFromStr("BeeS31"); images[1][3][2] =
		 * i.getImageFromStr("BeeS32"); images[1][4][0] =
		 * i.getImageFromStr("BeeS40"); images[1][4][1] =
		 * i.getImageFromStr("BeeS41"); images[1][4][2] =
		 * i.getImageFromStr("BeeS42"); images[1][5][0] =
		 * i.getImageFromStr("BeeS50"); images[1][5][1] =
		 * i.getImageFromStr("BeeS51"); images[1][5][2] =
		 * i.getImageFromStr("BeeS52"); images[1][6][0] =
		 * i.getImageFromStr("BeeS60"); images[1][6][1] =
		 * i.getImageFromStr("BeeS61"); images[1][6][2] =
		 * i.getImageFromStr("BeeS62"); images[1][7][0] =
		 * i.getImageFromStr("BeeS70"); images[1][7][1] =
		 * i.getImageFromStr("BeeS71"); images[1][7][2] =
		 * i.getImageFromStr("BeeS72");
		 */
	}

	/*
	 * @Override public Image getImage() { return images[selected ? 1 :
	 * 0][imageNumber][state]; }
	 */
